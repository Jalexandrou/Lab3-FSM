...
VL_ATTR_COLD void Vf1_clkfsm___024root___settle__TOP__0(Vf1_clkfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clkfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clkfsm___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vf1_clkfsm___024root___eval_initial(Vf1_clkfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clkfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clkfsm___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
    vlSelf->__Vclklast__TOP__rst = vlSelf->rst;
}

VL_ATTR_COLD void Vf1_clkfsm___024root___eval_settle(Vf1_clkfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clkfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clkfsm___024root___eval_settle\n"); );
    // Body
    Vf1_clkfsm___024root___settle__TOP__0(vlSelf);
}

VL_ATTR_COLD void Vf1_clkfsm___024root___final(Vf1_clkfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clkfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clkfsm___024root___final\n"); );
}

VL_ATTR_COLD void Vf1_clkfsm___024root___ctor_var_reset(Vf1_clkfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clkfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clkfsm___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->f1_clkfsm__DOT__tick = VL_RAND_RESET_I(1);
    vlSelf->f1_clkfsm__DOT__sec_clk__DOT__count = VL_RAND_RESET_I(16);
    vlSelf->f1_clkfsm__DOT__statemachine__DOT__current_state = 0;
    vlSelf->f1_clkfsm__DOT__statemachine__DOT__next_state = 0;
    vlSelf->__Vdly__f1_clkfsm__DOT__sec_clk__DOT__count = VL_RAND_RESET_I(16);
}
